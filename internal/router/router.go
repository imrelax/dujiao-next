	...
	apiV1 := r.Group("/api/v1")
	{
		...
		admin := apiV1.Group("/admin")
		{
			...
			paymentProtected := admin.Group("", PaymentComplianceRequired(c.ComplianceService))
			{
				...
				authorized.GET("/digital-contents", adminHandler.GetDigitalContents)
				authorized.POST("/digital-contents", adminHandler.CreateDigitalContent)
				authorized.GET("/digital-contents/:id", adminHandler.GetDigitalContent)
				authorized.PUT("/digital-contents/:id", adminHandler.UpdateDigitalContent)
				authorized.DELETE("/digital-contents/:id", adminHandler.DeleteDigitalContent)
