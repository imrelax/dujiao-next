...
var (
	...
	ErrDigitalContentNotFound              = errors.New("digital content not found")
	ErrDigitalContentInvalid               = errors.New("digital content invalid")
	ErrDigitalContentBindingConflict       = errors.New("digital content binding conflict")
	ErrDigitalContentProductHasCardSecret  = errors.New("digital content product has card secret")
	ErrCardSecretProductHasDigitalContent  = errors.New("card secret product has digital content")
	ErrDigitalContentUpstreamNotAllowed    = errors.New("digital content upstream not allowed")
	ErrDigitalContentSaveFailed            = errors.New("digital content save failed")
)
