...
var messages = map[string]map[string]string{
	LocaleZH: {
		...
		"error.digital_content_not_found":                "数字内容不存在",
		"error.digital_content_invalid":                  "数字内容参数不合法",
		"error.digital_content_binding_conflict":         "该商品/SKU 已绑定其它数字内容",
		"error.digital_content_product_has_card_secret":  "该商品已配置卡密，不能再绑定数字内容",
		"error.digital_content_save_failed":              "保存数字内容失败",
	...
	LocaleTW: {
		...
		"error.card_secret_not_found":                    "卡密不存在",
		"error.digital_content_not_found":                "數字內容不存在",
		"error.digital_content_invalid":                  "數字內容參數不合法",
		"error.digital_content_binding_conflict":         "該商品/SKU 已綁定其它數字內容",
		"error.digital_content_product_has_card_secret":  "該商品已設定卡密，不能再綁定數字內容",
		"error.digital_content_save_failed":              "儲存數字內容失敗",
	...
	LocaleEN: {
		...
		"error.digital_content_not_found":                "Digital content not found",
		"error.digital_content_invalid":                  "Invalid digital content data",
		"error.digital_content_binding_conflict":         "This product/SKU is already bound to another digital content",
		"error.digital_content_product_has_card_secret":  "This product already has card secrets and cannot bind digital content",
		"error.digital_content_save_failed":              "Failed to save digital content",
