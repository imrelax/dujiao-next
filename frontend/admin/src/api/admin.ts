...
export const adminAPI = {
  ...
  batchUpdatePostStatus: (ids: number[], isPublished: boolean) => api.post('/admin/posts/batch-status', { ids, is_published: isPublished }),
  batchUpdatePostCategory: (ids: number[], categoryId: number) => api.post('/admin/posts/batch-category', { ids, category_id: categoryId }),
  batchDeletePosts: (ids: number[]) => api.post('/admin/posts/batch-delete', { ids }),
